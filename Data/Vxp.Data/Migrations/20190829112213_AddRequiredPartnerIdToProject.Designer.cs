...
namespace Vxp.Data.Migrations
{
    ...
    [Migration("20190829112213_AddRequiredPartnerIdToProject")]
    partial class AddRequiredPartnerIdToProject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vxp.Data.Models.CommonProductDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CommonProductDetails");
                });
            ...
            modelBuilder.Entity("Vxp.Data.Models.CustomerInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Vxp.Data.Models.OrderProduct", b =>
                {
                    ...
                    b.Property<string>("PriceModifierData");
            ...
            modelBuilder.Entity("Vxp.Data.Models.CustomerInvitation", b =>
                {
                    b.HasOne("Vxp.Data.Models.ApplicationUser", "Sender")
            ...
            modelBuilder.Entity("Vxp.Data.Models.ProductDetail", b =>
                {
                    b.HasOne("Vxp.Data.Models.CommonProductDetail", "CommonDetail")
                        .WithMany("ProductDetails")
                        .HasForeignKey("CommonDetailId")
                        .OnDelete(DeleteBehavior.Restrict);
