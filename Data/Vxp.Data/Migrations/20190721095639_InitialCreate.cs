        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLocation = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    Name = table.Column<string>(nullable: false),
                    BusinessNumber = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_Addresses_ContactAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Addresses_ContactAddressId",
                        column: x => x.ContactAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceModifierRange = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    PriceModifierType = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistributorKeys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DistributorKeys_BankAccounts_BankAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DistributorKeyId = table.Column<int>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistributorUser", x => new { x.ApplicationUserId, x.DistributorKeyId });
                    table.ForeignKey(
                        name: "FK_DistributorUser_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DistributorUser_DistributorKeys_DistributorKeyId",
                        column: x => x.DistributorKeyId,
                        principalTable: "DistributorKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ContactAddressId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistributorKeys_IsDeleted",
                table: "DistributorKeys",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_DistributorUser_DistributorKeyId",
                table: "DistributorUser",
                column: "DistributorKeyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceModifiers_IsDeleted",
                table: "PriceModifiers",
                column: "IsDeleted");
